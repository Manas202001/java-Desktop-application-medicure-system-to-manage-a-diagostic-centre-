...
public class BookSlot extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel4.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 260, 400, 110));
        ...
        jPanel4.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 320, 110));

        jLabel16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/LOGO-removebg-preview.png"))); // NOI18N
        jLabel16.setText("jLabel16");
        jPanel4.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 80, 60, -1));

        jLabel14.setFont(new java.awt.Font("Times New Roman", 0, 300)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel14.setText("24");
        jPanel4.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 260, 400, 430));
        ...
        jPanel4.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(680, 30, -1, 30));
        ...
        jLabel22.setText("Mobile number 2 : ");
        ...
        jPanel4.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 590, -1, 30));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String mn11=jTextField4.getText();
        String mn22=jTextField4.getText();
        //long mn1=Long.parseLong(jTextField4.getText());
        //long mn2=Long.parseLong(jTextField4.getText());        
        String sTest=jComboBox1.getName();
        int age=jSpinner1.getComponentCount();
        
         if(fName.isEmpty()||lName.isEmpty()||state.isEmpty()||city.isEmpty()||country.isEmpty()||address.isEmpty())
        {
            jLabel10.setText("* All fields are mendatory to be filled");
        }
        else
        {
            ...
            long mn1=Long.parseLong(mn11);
            long mn2=Long.parseLong(mn22); 
            user.beans.Users data=new user.beans.Users(address,aadharNo,age,city,mn1,mn2,fName,lName,sTest,state,country,' ');
            session.save(data);
            tx.commit();
            session.close();
            new SlotNo().setVisible(true);
            dispose();
       }
